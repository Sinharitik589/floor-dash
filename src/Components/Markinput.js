...
const Markinput = (props) => {
    ...
    const createRule = async () => {
        ...
        let object = {
            start: (start != "") ? reverseDate(start, "output") : "", end: (end != "") ? reverseDate(end, "output") : "", trade, charge, cargo,
                        ...
                        <div className="top-option-tab row no-gutters p-1 pt-2 pb-2  align-items-center w-100 h-max-content">
                                    ...
                                    <Dropdown.Menu >
                                        {
                                            loading_country_array.map((val, index) => <Dropdown.Item
                                                key={`input_loading_country_${index}`}
                                                eventKey={index} title={val.TXTKG} active={index === loadingCountry}>{val.COUNTRY}</Dropdown.Item>)
                                        }
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                            <div className="col-2  p-0">
                                <Dropdown onSelect={(e) => {
                                    ...
                                    <Dropdown.Menu >
                                        {
                                            loading_port_array.map((val, index) => <Dropdown.Item
                                                key={`input_loading_port_${index}`} title={val.PORT_DESC} eventKey={index} active={index === loadingPort}>{val.ZGC_PORT}</Dropdown.Item>)
                                        }
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                        ...
                        <div className="top-option-tab row no-gutters p-1 pt-2 pb-2  align-items-center w-100 h-max-content">
                                    ...
                                    <Dropdown.Menu >
                                        {
                                            discharge_area_array.map((val, index) =>
                                                <Dropdown.Item
                                                    key={`input_discharge_area_${index}`}
                                                    title={val.TXTMD} eventKey={index} active={index === loadingArea}>{val.AREA}</Dropdown.Item>)
                                        }
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                            ...
                            <div className="col-5 p-0 pr-1 pl-1">
                                <Dropdown onSelect={(e) => {
                                    ...
                                    <Dropdown.Menu >
                                        {
                                            pod_group_array.map((val, index) => <Dropdown.Item
                                                key={`input_discharge_group_${index}`}
                                                title={val.TXTSH} eventKey={index} active={index === pod}>{val.PGRP}</Dropdown.Item>)
                                        }
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                            <div className="col-3 p-0 pr-1">
                                <Dropdown onSelect={(e) => {
                                    ...
                                    <Dropdown.Menu >
                                        {
                                            discharge_country_array.map((val, index) => <Dropdown.Item
                                                key={`input_discharge_country_${index}`} eventKey={index} title={val.TXTKG} active={index === loadingCountry}>{val.COUNTRY}</Dropdown.Item>)
                                        }
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                                    ...
                                    <Dropdown.Menu >
                                        {
                                            discharge_port_array.map((val, index) => <Dropdown.Item
                                                key={`input_discharge_port_${index}`}
                                                title={val.PORT_DESC} eventKey={index} active={index === loadingPort}>{val.ZGC_PORT}</Dropdown.Item>)
                                        }
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                        ...
                        <div className="top-option-tab row no-gutters p-1 pt-2 pb-2  align-items-center w-100 h-max-content">
                            <div className="col-12 p-0 pr-1">
                                <Dropdown onSelect={(e) => {
                                    ...
                                    <Dropdown.Menu >
                                        {
                                            cargo_array.map((val, index) => <Dropdown.Item
                                                key={`input_discharge_cargo_${index}`}
                                                title={val.CONTAINER_GROUP} eventKey={index} active={index === loadingPort}>{val.CONTAINER_TYPE}</Dropdown.Item>)
                                        }
                                    </Dropdown.Menu>
                                </Dropdown>
                                    ...
                                    <Dropdown.Menu >
                                        {
                                            denomination_array.map((val, index) => <Dropdown.Item
                                                key={`input_discharge_deno_${index}`} eventKey={index} active={index === denomination}>{val}</Dropdown.Item>)
                                        }
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                            ...
                            <div className="col-7 p-0 pr-1 row no-gutters justify-content-center align-items-center">
                                {
                                    (start === "" || end === "" || !(dischargeArea !== "" || dischargeCountry !== "" || dischargePort !== "" || pod !== "") ||
                                        !(loadingArea !== "" || loadingCountry !== "" || loadingPort !== "" || pol !== "") || trade === "" || cargo === "" || denomination === "" || charge === "" || isNaN(charge)) ? "" : (props.selected_index == undefined) ? <Button onClick={createRule} className="p-0 w-100 small-font" text={(loader) ? <Row className="w-100 justify-content-center" noGutters>{"Creating"}<Spinner size="sm" animation="border" /></Row> : "Create"}>
